...
func Handler(w http.ResponseWriter, r *http.Request) {
	...
	router.PUT("/api/v1/admin/projects/:id", middleware.RequireAuth(bootstrap.AuthSvc), h.Update)
	router.DELETE("/api/v1/admin/projects/:id", middleware.RequireAuth(bootstrap.AuthSvc), h.Delete)
