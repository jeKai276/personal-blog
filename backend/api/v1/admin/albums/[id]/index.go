...
func Handler(w http.ResponseWriter, r *http.Request) {
	...
	router.PUT("/api/v1/admin/albums/:id", middleware.RequireAuth(bootstrap.AuthSvc), h.UpdateAlbum)
	router.DELETE("/api/v1/admin/albums/:id", middleware.RequireAuth(bootstrap.AuthSvc), h.DeleteAlbum)
