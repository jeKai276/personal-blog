...
func Handler(w http.ResponseWriter, r *http.Request) {
	...
	router.DELETE("/api/v1/admin/photos/:id", middleware.RequireAuth(bootstrap.AuthSvc), h.DeletePhoto)
	router.PATCH("/api/v1/admin/photos/:id", middleware.RequireAuth(bootstrap.AuthSvc), h.UpdatePhoto)
