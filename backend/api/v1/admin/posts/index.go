...
func Handler(w http.ResponseWriter, r *http.Request) {
	...
	router.GET("/api/v1/admin/posts", middleware.RequireAuth(bootstrap.AuthSvc), h.ListAll)
	router.POST("/api/v1/admin/posts", middleware.RequireAuth(bootstrap.AuthSvc), h.Create)
